...
class ManipulatorRobot:
    ...
    Example of controlling the robot with a policy (without running multiple algo in parallel to ensure highest frequency):
    ```python
    ...
    def connect(self):
        ...
        if self.robot_type in ["koch", "koch_bimanual", "aloha"]:
            ...
            from lecoro.common.robot_devices.motors.feetech import TorqueMode
    ...
    def activate_calibration(self):
        ...
        def load_or_run_calibration_(name, arm, arm_type):
            ...
            if arm_calib_path.exists():
                ...
                if self.robot_type in ["koch", "koch_bimanual", "aloha"]:
                    from lecoro.common.robot_devices.robots.dynamixel_calibration import run_arm_calibration

                    calibration = run_arm_calibration(arm, self.robot_type, name, arm_type)

                elif self.robot_type in ["so100", "moss"]:
                    from lecoro.common.robot_devices.robots.feetech_calibration import (
