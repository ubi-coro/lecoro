...
LOWER_BOUND_LINEAR = -60
UPPER_BOUND_LINEAR = 160
...
class DynamixelMotorsBus:
    ...
    def connect(self):
        ...
        try:
            ...
            traceback.print_exc()
            print(
                "\nTry running `python lecoro/scripts/find_motors_bus_port.py` to make sure you are using the correct port.\n"
            )
            raise
            ...
            if CalibrationMode[calib_mode] == CalibrationMode.DEGREE:
                ...
                if (values[i] < LOWER_BOUND_DEGREE) or (values[i] > UPPER_BOUND_DEGREE):
                    raise JointOutOfRangeError(
                        ...
                        "You need to recalibrate by running: `python lecoro/scripts/control_robot.py calibrate`"
                    )
