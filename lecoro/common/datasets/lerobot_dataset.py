...
from lecoro.common.datasets.compute_stats import aggregate_stats, compute_stats
from lecoro.common.datasets.image_writer import AsyncImageWriter, write_image
...
from lecoro.common.datasets.video_utils import (
    VideoFrame,
...
# For maintainers, see lecoro/common/datasets/push_dataset_to_hub/CODEBASE_VERSION.md
CODEBASE_VERSION = "v2.0"
LEROBOT_HOME = Path(os.getenv("LEROBOT_HOME", "~/.cache/huggingface/lecoro")).expanduser()
...
class LeRobotDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        1. Your dataset already exists:
            ...
            - On the Hugging Face Hub at the address https://huggingface.co/datasets/{repo_id} and not on
              ...
              lecoro/common/datasets/v2/convert_dataset_v1_to_v2.py.
    ...
    def _query_hf_dataset(self, query_indices: dict[str, list[int]]) -> dict:
        # manually integrated from PR#634
