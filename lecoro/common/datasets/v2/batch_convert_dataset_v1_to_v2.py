...
"""
This script is for internal use to convert all datasets under the 'lecoro' hub user account to v2.

Note: Since the original Aloha datasets don't use shadow motors, you need to comment those out in
lecoro/configs/robot/aloha.yaml before running this script.
"""
...
from lecoro.common.datasets.v2.convert_dataset_v1_to_v2 import convert_dataset, parse_robot_config

LOCAL_DIR = Path("data/")

ALOHA_CONFIG = Path("lecoro/configs/robot/aloha.yaml")
ALOHA_MOBILE_INFO = {
    ...
    "asu_table_top": {
        ...
        "citation_bibtex": dedent(r"""
            ...
            @article{zhou2023learning,
                title={Learning modular language-conditioned robot algo through attention},
