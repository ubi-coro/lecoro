...
def cfg_to_group(cfg: Config, return_list: bool = False) -> list[str] | str:
...
class Logger:
    ...
    def __init__(self, cfg: Config, log_dir: str, wandb_job_name: str | None = None):
        """
        Args:
    ...
    def save_model(self, save_dir: Path, algo: Algo, wandb_artifact_name: str | None = None):
        """Save the weights of the Algo using PyTorchModelHubMixin.
    ...
    def save_checkpoint(
        ...
        self.save_model(
            checkpoint_dir / self.pretrained_model_dir_name, algo, wandb_artifact_name=wandb_artifact_name
        )
        self.save_training_state(checkpoint_dir, train_step, algo)
        os.symlink(checkpoint_dir.absolute(), self.last_checkpoint_dir)

    def load_last_training_state(self, algo) -> int:
        """
