...
python lecoro/scripts/control_robot.py teleoperate --robot-overrides '~cameras'
```
...
from lecoro.common.robot_devices.utils import busy_wait, safe_disconnect
from lecoro.common.utils.utils import init_hydra_config, init_logging, log_say, none_or_int
