...
def configure_motor(port, brand, model, motor_idx_des, baudrate_des):
    if brand == "feetech":
        from lecoro.common.robot_devices.motors.feetech import MODEL_BAUDRATE_TABLE
        from lecoro.common.robot_devices.motors.feetech import (
            SCS_SERIES_BAUDRATE_TABLE as SERIES_BAUDRATE_TABLE,
        )
        from lecoro.common.robot_devices.motors.feetech import FeetechMotorsBus as MotorsBusClass
    elif brand == "dynamixel":
        from lecoro.common.robot_devices.motors.dynamixel import MODEL_BAUDRATE_TABLE
        from lecoro.common.robot_devices.motors.dynamixel import (
            X_SERIES_BAUDRATE_TABLE as SERIES_BAUDRATE_TABLE,
        )
        from lecoro.common.robot_devices.motors.dynamixel import DynamixelMotorsBus as MotorsBusClass
    else:
        raise ValueError(
