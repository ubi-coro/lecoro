...
from lecoro.common.datasets.factory import make_dataset, resolve_delta_timestamps
from lecoro.common.datasets.lerobot_dataset import MultiLeRobotDataset
from lecoro.common.datasets.online_buffer import OnlineBuffer, compute_sampler_weights
...
def make_optimizer_and_scheduler(cfg, policy):
    if cfg.policy.name == "act":
        ...
        from lecoro.common.algo.vqbet.modeling_vqbet import VQBeTOptimizer, VQBeTScheduler
